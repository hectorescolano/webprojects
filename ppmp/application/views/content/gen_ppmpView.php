...
<div class="container well" style="font-size:80%;">
   
    <input type="hidden" id='offcode' value='<?php echo $userlogged_data->sys_suboffice_code;?>'>
    <div class="text-center"><h3>CREATE PROCUREMENT PLAN</h3></div>
    <div class="col-md-offset-3 col-md-6">
        <form method="post" action="GeneratePPMP">
            ...
            <div class="form-group">
                ...
                <select id="contracttype" name="ppmp[contracttype]" class="form-control" required="">
                    <option value="">[Select here]</option>
