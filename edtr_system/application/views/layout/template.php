    ...
    <body>
        <div>
            ...
            <div class="container-fluid">
                <?php 
//                    var_dump($this->session->userdata['ses_edtrsys']);
                if (isset($this->session->userdata['ses_edtrsys'])) { ?>
                    <div class="hidden-print text-right header">
                        <span id='datetime'></span> |
                        Logged user: <span class="glyphicon glyphicon-user
                                           " aria-hidden="true"></span> <?php echo strtoupper($this->session->userdata['ses_edtrsys'][0]->USERID); ?> <a class="label label-default" style='font-size: 10px;' href="logout"><span class="glyphicon glyphicon-log-out"></span> LOGOUT</a></span>
                    </div>
                <?php } else { ?>
            ...
            <br>
            <br>
            <p class="hidden-print footer">Copyright © 2017 eDTR System v1.0</p>
