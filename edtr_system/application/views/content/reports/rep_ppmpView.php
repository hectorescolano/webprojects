                ...
                <tr class="text-center">
                    ...
                    <?php
                        ...
                        foreach ($ppmp_reports as $row) {
                            ...
                            echo "<td class='text-right'>".number_format((float)$row->TotalAmount, 2, '.', ',')."</td>";
                            echo "<td>$row->proc_method</td>";
                            echo "<td class='text-right'></td>"; //jan
                            echo "<td class='text-right'></td>"; //feb
                            echo "<td class='text-right'></td>"; //mar
                            echo "<td class='text-right'></td>"; //april
                            echo "<td class='text-right'></td>"; //may
                            echo "<td class='text-right'></td>"; //jun
                            echo "<td class='text-right'></td>"; //jul
                            echo "<td class='text-right'></td>"; //aug
                            echo "<td class='text-right'></td>"; //set
                            echo "<td class='text-right'></td>"; //oct
                            echo "<td class='text-right'></td>"; //nov
                            echo "<td class='text-right'></td>"; //dec
                            echo "</tr>";
                            $ctr++;
                        }
            ...
            <table style="font-size: 10px;width: 100%;">
                ...
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td width="40%" style="vertical-align: top;"><strong><small>Prepared By:</small></strong></td>
                                <td>
                                    <table>
                                        <tr>
                                            <td>
